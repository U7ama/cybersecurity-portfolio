...
Botium Toys needs to put proper procedures and policies for the controls which it lacks, including: Least privilege, recovery plans, separation of duties, encryption, intrusion detection system, password management systems, and legacy systems.

 There is a strict need to adhere to the compliance regulation policies: payment card data confidentiality, general data protection regulation,and system and organisation controls .

 Fulfilling the inadequate controls and compliance will improve the security posture of the organization. 